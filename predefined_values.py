...
MPPT_SIZES = [
   20, 30, 40, 50, 60, 70, 80, 90, 100, 200, 300, 500, 1000, 2000, 3000, 5000, 6000, 8000, 10000, 15000, 20000,
    25000, 30000, 40000, 50000, 60000, 70000, 80000, 100000
]

# Charge controllers (in Amps)
SCC_SIZES = [
    20,30, 40, 50, 60, 80, 100, 120, 150, 200, 250, 300, 400, 500, 600, 700,
    800, 1000, 1200, 1500
]
...
# Cable sizes (in mm²)
CABLE_SIZES = [
    1.5, 2.5, 4, 6, 10, 16, 25, 35, 50, 70, 95, 120, 150, 185, 240, 300, 400, 500, 600,
    750, 900, 1200
]
...
# Wire size conversion from mm² to AWG (American Wire Gauge)
WIRE_SIZE_CONVERSION = {
    2.5: 14, 4: 12, 6: 10, 10: 8, 16: 6, 25: 4, 35: 2, 50: 1, 70: 0, 95: "00",
    120: "000", 150: "0000", 185: "0000 (quadruple 0)", 240: "250 kc-mil",
    300: "300 kc-mil", 400: "350 kc-mil", 500: "500 kc-mil", 600: "600 kc-mil",
    750: "750 kc-mil", 900: "900 kc-mil"
}
